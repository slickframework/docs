...
If you wat to use a Slick module in your existing project just add the corespondent module name your project
``composer.json`` file.
Lets have an example. Adding the ``slick/template`` Slick module to your project is as simple as adding the
following line to your project's ``composer.json`` file:
